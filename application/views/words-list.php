            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Word List</li>
                    </ol>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
        ...
        columns: [
            ...
            // { data: 'publish', title: 'Published', render: function(data) { return data == 'true' ? 'Yes' : 'No'; } },
            {
                ...
                render: function(data) {
                    return `
                        ${__adminPreviewBtn(data)}<a href="<?= base_url('word/edit/') ?>${data}" class="btn btn-sm btn-primary">Edit</a>
                        <button class="btn btn-sm btn-danger delete-word" data-id="${data}">Delete</button>
                    `;
                }
            }
        ],
    ...
    $('#wordsTable').on('click', '.delete-word', function() {
        var id = $(this).data('id');
        Swal.fire({
            title: 'Are you sure?',
