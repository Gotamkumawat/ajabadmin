  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-2 col-md-4 col-sm-6">
        <a href="filmDetails-list" style="text-decoration: none;">
      ...
      <!-- 🎞️ Film Episode -->
      <div class="col-lg-2 col-md-4 col-sm-6">
        <a href="filmEpisodeDetails-list" style="text-decoration: none;">
          <div class="small-box bg-info" style="cursor: pointer;">
            <div class="inner">
              <h3 style="color: white; font-size: 20px; margin: 8px 0;">Film Episodes</h3>
            </div>
            <div class="icon">
